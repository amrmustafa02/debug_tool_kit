      ...
      child: Scaffold(
        ...
        body: ListView(
          ...
          children: [
            ...
            _buildSection('Request Headers', _formatBody(entry.requestHeaders)),
            _buildSection('Request Body', _formatBody(entry.requestBody)),
            _buildSection('Response Body', _formatBody(entry.responseBody)),
            if (entry.error != null) _buildSection('Error', entry.error!),
          ],
        ),
      ),
    );
